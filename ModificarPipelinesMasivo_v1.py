...
def productionSteps(div_path):
    ...
    pipeline = readTXT("resources/pipeline_prod2.txt")
    new_pipeline = []
    contador = 0
...
def UATSteps(div_path):
    ...
    pipeline = readTXT("resources/pipeline_uat2.txt")
    new_pipeline = []
    for line in pipeline:
        if change1 in line:
            if change2 in line:
...
def jenkinsPipeline():
    i = 0
    urls = readCSV("resources/archivosdeEjecucion/ejecutar.csv")
    segunda = 0
    try:
        ...
        for url in urls:
            ...
            btnSave = browser.find_element(By.XPATH, "/html[1]/body[1]/div[6]/div[1]/div[1]/div[1]/div[1]/form[1]/table[1]/tbody[1]/tr[217]/td[1]/div[2]/div[2]/span[1]/span[1]")
